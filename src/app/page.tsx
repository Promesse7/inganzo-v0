      ...
      <div className="grid md:grid-cols-2 gap-8 items-center">
        <div>
          ...
          <div className="mt-6 flex gap-3">
            <Link href="/lessons" className="px-5 py-3 rounded-2xl bg-primary text-white">Start Learning</Link>
            <Link href="/upload" className="px-5 py-3 rounded-2xl border">Submit Testimony</Link>
          </div>
        </div>
